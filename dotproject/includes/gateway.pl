...
sub mail_report {
	...
	print MAIL "		<TD bgcolor=white nowrap><a href='http://staging.dotmarketing.net/dotproject/index.php?m=ticketsmith&a=view&ticket=$ticket'><font face=arial,san-serif size=2>http://staging.dotmarketing.net/dotproject/index.php?m=ticketsmith&a=view&ticket=$ticket</font></a></TD>";
	print MAIL "	</tr>";
	print MAIL "</TABLE>";
	print MAIL "</body>";
	print MAIL "</html>";
