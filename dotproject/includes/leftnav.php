...
<TR  <?php if($m == "proje4cts"){?> bgcolor="#ffffff" <?php }?>>
        <TD align="center" valign=middle class="clsBtnOff">
        <table cellspacing=0 cellpadding=0 border=0><tr><td class="clsBtnOff">
        <A href="./index.php?m=ticketsmith"><img src="./images/icons/ticketsmith.gif"  onmouseover="doBtn();" onmouseout="doBtn();" onmousedown="doBtn();" onmouseup="doBtn();" alt="Tickets" border="0" width="42" height="42"></a>
        </td></tr></table>
        Tickets
        </TD>
</TR>
