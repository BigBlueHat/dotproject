...
//
require_once( $AppUI->getLibraryClass( 'PEAR/HTTP/WebDAV/Tools/_parse_propfind_response' ) );
require_once( $AppUI->getLibraryClass( 'PEAR/HTTP/WebDAV/Tools/_parse_lock_response' ) );
