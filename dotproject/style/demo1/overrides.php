	...
	// tabbed / flat view options
		...
		// tabbed view
			...
			foreach( $this->tabs as $k => $v ) {
				...
				$s .= '<td valign="middle" width="1%" nowrap="nowrap"  background="./style/demo1/images/tab'.$sel.'Bg.png">&nbsp;' .
				  ($k == $this->active ? $AppUI->_($v[1]) : '<a href="'.$this->baseHRef.'tab='.$k.'">'.$AppUI->_($v[1]).'</a>' ) .
				'&nbsp;</td>';
