...
/**********************************************/
	...
	<TABLE border=0 cellpadding=2 cellspacing=1 width="95%" >
		...
		<TD><A href="./index.php?m=forums">All forums</a></td>
			<TD align="right"><input type="button" class=button style="width:120;" value="start a new topic" onClick="javascript:window.location='./index.php?m=forums&a=viewer&forum_id=<?echo $forum_id;?>&post_message=1';"></td>
			</TR>
		</TABLE>
		<TABLE border=0 cellpadding=2 cellspacing=1 width="95%" >
		<TR bgcolor="silver">
...
//JBF limit displayed messages to first-in-thread
			...
			<TR bgcolor="#eeeeee">
				...
				<TD bgcolor=#dddddd><?echo $parr[$x]["user_username"];?></td>
