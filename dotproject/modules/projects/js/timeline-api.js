...
(function() {
    ...
    try {
         ...
         */
        if (bundle) {
			// modified for dotproject - added bundle sub directory
            includeJavascriptFiles(Timeline.urlPrefix + "bundle/", [ "bundle.js" ]);
            includeCssFiles(Timeline.urlPrefix + "bundle/", [ "bundle.css" ]);
        } else {
