...
<table border="0" cellpadding="0" cellspacing="0" width="99%" bgcolor="silver">
		...
		<tr class="basic" valign="top">
			...
			<table>
				<tr>
					<td valign="bottom"><span id="ccsprojectnamestr"><span class="FormLabel">project name</span> <span class="FormElementRequired">*</span></span><br>
						<input type="text" name="project_name" value="<?php echo @$prow["project_name"];?>" size="25" maxlength="50" onBlur="setShort();"></td>
					<td>&nbsp;</td>
					<td valign="bottom"><span id="ccsprojectnamestr"><span class="FormLabel">company name</span> <span class="FormElementRequired">*</span></span><br>
								...
								<?php while($row = mysql_fetch_array($crc)){?>
									<option value="<?php echo $row["company_id"];?>" <?php if($row["company_id"] == $prow["project_company"]){echo "selected";}?>><?php echo $row["company_name"];?>  
								<?php }?></select></td>
				</tr>
			</table>
			...
			<td>
				...
				<input type="text" name="project_short_name" value="<?php echo @$prow["project_short_name"];?>" size="10" maxlength="10">
			</td>
			<td>
				...
				<input type="text" name="project_color_identifier" value="<?php echo @$prow["project_color_identifier"];?>" size="6" onBlur="setColor();"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<OPTION VALUE="31" <?php if(@date("d", $start_date) == 31){?>selected<?php }?>>31 </select>/
...
<OPTION VALUE="2009" <?php if(@date("Y", $start_date) == 2009){?>selected<?php }?>>2009 </select>
						</td><td valign="bottom">
			...
			<td colspan="2">
				<TABLE width="100%" bgcolor="#eeeeee">
					...
					<TR>
						...
						<TD>	<b><?php echo intval(@$prow["project_precent_complete"]);?> %</b>
					</TD>
					<TD>
					<input type=checkbox value=1 name=project_active <?php if($prow["project_active"]){?>checked<?php }?>>
					</TD>
				</TR>
			</TABLE>
			</td>
...
<OPTION VALUE="2009" <?php if(@date("Y", $end_date) == 2009){?>selected<?php }?>>2009 </select>
						</td><td valign="bottom">
...
<OPTION VALUE="2009">2009 </select>
		...
		URL<br>		
		<input type="Text" name="project_url" value="<?php echo @$prow["project_url"];?>" size="50" maxlength="255""><br>
		Staging URL<br>
		<input type="Text" name="project_demo_url" value="<?php echo @$prow["project_demo_url"];?>" size="50" maxlength="255"">
