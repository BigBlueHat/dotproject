...
if ($stub) {
	$sql .= "\n	AND (UPPER(user_username) LIKE '$stub%' or UPPER(contact_first_name) LIKE '$stub%' OR UPPER(contact_last_name) LIKE '$stub%')";
} else if ($where) {
	$sql .= "\n	AND (UPPER(user_username) LIKE '%$where%' or UPPER(contact_first_name) LIKE '%$where%' OR UPPER(contact_last_name) LIKE '%$where%')";
}
