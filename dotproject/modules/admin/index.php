...
if ($perm[0] == 0) {
	...
	window.location="./index.php?m=admin&a=viewuser&user_id='.$user_cookie.'&message=ACCESS DENIED: You have insufficient permissions to view the administration module.";
	</script>
';
}
		...
		<TD valign="top" colspan=2>
			<TABLE width="100%" cellpadding="1" cellspacing=1 >
				...
				<?php while($row = mysql_fetch_array($urow)){?>
					...
					<TD><A href="./index.php?m=admin&a=viewuser&user_id=<?php echo $row["user_id"];?>"><?php echo $row["user_username"];?></a></td>
